...
import 'package:ticketpro2/customerpages/downloadpage.dart';
...
final token;
  ...
  const ConfirmPage({required this.token, super.key});
  @override
                        ...
                        child: TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>  DownloadPage(token: widget.token),
                              ),
                            );
                            },
                            child: Container(
