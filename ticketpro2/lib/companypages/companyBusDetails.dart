...
class CompanyBusDetails extends StatefulWidget {
  final token;
  final String origin; 
  final String destination;
  const CompanyBusDetails({super.key, required this.token,required this.origin, required this.destination });

  @override
  _CompanyBusDetailsState createState() => _CompanyBusDetailsState();
}

class _CompanyBusDetailsState extends State<CompanyBusDetails> {
  ...
  showDialog(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Failed to delete bus $resp');
         Fluttertoast.showToast(
      ...
      children: [
        Row(
          children: [
            ...
            buildHeaderCell('seats available'),
